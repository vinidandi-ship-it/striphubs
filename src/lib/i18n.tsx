...
const dict: Record<Lang, Dict> = {
  en: {
    ...
    realtimeFeed: 'Real-time feed powered by Stripchat affiliate widget.',
    categoryLive: '{category} Live Cams',
    categoryRealtime: 'Real-time category feed powered by Stripchat.',
    tagRealtime: 'Real-time tag feed powered by Stripchat.',
    searchTitle: 'Search',
  ...
  it: {
    ...
    realtimeFeed: 'Feed in tempo reale powered by widget affiliato Stripchat.',
    categoryLive: 'Live Cam {category}',
    categoryRealtime: 'Feed categoria in tempo reale powered by Stripchat.',
    tagRealtime: 'Feed tag in tempo reale powered by Stripchat.',
    searchTitle: 'Ricerca',
  ...
  es: {
    ...
    realtimeFeed: 'Feed en tiempo real con widget afiliado de Stripchat.',
    categoryLive: 'Cámaras en vivo {category}',
    categoryRealtime: 'Feed de categoría en tiempo real por Stripchat.',
    tagRealtime: 'Feed de tag en tiempo real por Stripchat.',
    searchTitle: 'Buscar',
  ...
  fr: {
    ...
    realtimeFeed: 'Flux en temps réel via widget affilié Stripchat.',
    categoryLive: 'Cams live {category}',
    categoryRealtime: 'Flux catégorie en temps réel via Stripchat.',
    tagRealtime: 'Flux tag en temps réel via Stripchat.',
  ...
  de: {
    ...
    realtimeFeed: 'Echtzeit-Feed mit Stripchat Affiliate Widget.',
    categoryLive: '{category} Live-Cams',
    categoryRealtime: 'Echtzeit-Kategorie-Feed von Stripchat.',
    tagRealtime: 'Echtzeit-Tag-Feed von Stripchat.',
    searchTitle: 'Suche',
  ...
  pt: {
    ...
    realtimeFeed: 'Feed em tempo real com widget afiliado Stripchat.',
    categoryLive: 'Cams ao vivo {category}',
    categoryRealtime: 'Feed de categoria em tempo real via Stripchat.',
    tagRealtime: 'Feed de tag em tempo real via Stripchat.',
    searchTitle: 'Busca',
