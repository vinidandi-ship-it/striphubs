...
export default function Videos() {
  ...
  useSEO(
    t('videos.title') || 'Porn Videos - Top Rated XXX Videos',
    t('videos.description') || 'Watch the hottest porn videos online for free. Top rated XXX content updated daily.',
    '/videos',
    { lang: language }
  );
  ...
  const popularTags = [...new Set(videos.flatMap(v => v.tags))].slice(0, 20);
    ...
    <div className="space-y-6">
      <div className="text-center space-y-2">
        <h1 className="text-3xl font-bold text-white">
          {t('videos.title') || 'Top Porn Videos'}
        </h1>
